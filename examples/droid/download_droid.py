...
class DROIDDownloader:
    ...
    def download_trajectory(self, trajectory_path: str, output_dir: str) -> str:
        """
    ...
    def download_sample_trajectories(self, output_dir: str, num_success: int = 2, num_failure: int = 2):
        """
