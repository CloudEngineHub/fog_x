...
from robodm.agent.tools import (
    ...
    analyze_image, analyze_trajectory, detect_scene_changes, extract_keyframes,
    # New tool system
    ToolsManager, VisionLanguageModelTool, ImageAnalysisTool, TrajectoryAnalysisTool,
    get_registry, create_manager
)
...
class TestImageAnalysisTool:
    ...
    def test_image_analysis_tool_init(self):
        ...
        tool = ImageAnalysisTool(blur_threshold=80.0, brightness_threshold=0.25)
