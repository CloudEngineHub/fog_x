...
class ToolsManager:
    ...
    def __init__(self, registry: Optional[ToolRegistry] = None, config: Optional[Dict[str, Any]] = None):
        """
    ...
    def get_tools_namespace(self, tool_names: Optional[List[str]] = None) -> Dict[str, BaseTool]:
        """
...
class LegacyToolsManager(ToolsManager):
    ...
    def _register_legacy_tools(self):
        ...
        try:
            from .implementations import VisionLanguageModel, analyze_image, analyze_trajectory
            from .base import register_tool, ToolMetadata
            ...
            class AnalyzeImageTool(FunctionBaseTool):
                def __init__(self, **kwargs):
                    metadata = ToolMetadata(
                        name="analyze_image",
                        description="Analyze image properties (blur, brightness, features)",
                        examples=[
            ...
            class AnalyzeTrajectoryTool(FunctionBaseTool):
                def __init__(self, **kwargs):
                    metadata = ToolMetadata(
                        ...
                        description="Analyze trajectory data (velocity, statistics, anomalies)",
                        examples=[
